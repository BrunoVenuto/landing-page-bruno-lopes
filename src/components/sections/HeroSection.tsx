      ...
      <div className="text-center z-10 space-y-12 max-w-4xl px-4">
        ...
        >
          ...
          <div className="w-full h-full border-2 border-[#00f5ff] rounded-none cyber-container flex items-center justify-center relative bg-black/50">
            ...
            <TerminalSquare className="w-16 h-16 md:w-24 md:h-24 text-[#00f5ff]" />
          </div>
        </motion.div>
        ...
        >
          <h1
            className="text-7xl md:text-8xl font-bold tracking-tighter text-white glitch-text-hq uppercase"
        ...
        >
          <div className="inline-block bg-[#00f5ff]/10 border border-[#00f5ff]/30 px-6 py-2">
            <p className="text-[#00f5ff] text-xl md:text-2xl font-bold tracking-widest uppercase">
              &gt; Full Stack Developer_
            </p>
          </div>
          <p className="text-[#e0e0e0] max-w-2xl mx-auto leading-relaxed text-lg">
